...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Person customer2 = new Person("John Smith", 48);
        ...
        System.out.println("Default Base Commission Pay: " + STARTING_RATE);
        System.out.println("Default Commission Percent: " + STARTING_COMMISSION);
        //                                          ID, StId, Name, Age
        Employee employee3 = new CommissionEmployee(003, 1, "Mary Warren", 18 );
        ...
        //System.out.println("Total Commission Earned: " + getAllEmployeesTotalCommission());
    }
}
